...
class Book:
    def __init__(self, url_of_book, title="", category="", description="", price="", number=""):
    ...
    def get_book_urls(self):
        ...
        for url_of_category in urls_of_categories:
            while True:
                ...
                urls_a = [url_of_book.find('a')["href"] for url_of_book in books_urls_nodes]
                urls_on_page = [self.base_url + "catalogue/" + clean_text(url_of_book) for url_of_book in urls_a]
